package com.orodent.tonv2.features.inventory.controller;
    ...
    private Node createPopupForItem(Item item) {
        ...
        for (var lot : lotti) {
            ...
            if (stocks == null || stocks.isEmpty()) {
                Label row = new Label(lot.code() + " — qty 0");
